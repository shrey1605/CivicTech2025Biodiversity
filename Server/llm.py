...
def get_sub_species_info_from_LLM(species_info):
    ...
    response = ai_model.generate_content(f"Create a description that details the basic facts of this plant including historic usage and basic featues of the plant {species_info}")
